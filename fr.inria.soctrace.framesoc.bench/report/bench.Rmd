...
# plot                                                                                                                                                             
ggplot(re, aes(x=size, y=mean, colour=index)) +                                                                                                                
...
TODO: verify values for import with index (expecially for medium and big)
...
dt <- data.table(read.csv("../results/reader_first.log"))                                                                                      
...
Parse res with python script, to create configuration merging 3 factors (parsed.log).
