...
- Actually, even with an index on event id, in the EVENT_PARAM table, the performance with parameters does not change.
  This is not intuitive. Anyway, given that the import time increases a lot (3x) for big traces, this index on event 
  id is not currently justifiable.
...
- Interval reading ([with index, without parameters] == gantt) increments total time by a factor from 3 to 2 
